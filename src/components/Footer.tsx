          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              ...
              <a 
                ...
                className="flex items-center text-sm hover:text-accent transition-colors duration-200"
              >
                <Phone className="h-4 w-4 mr-3 text-accent flex-shrink-0" />
                <span>(17) 99177-9710</span>
              </a>
              <a 
                href="mailto:marcosponego@gmail.com"
                className="flex items-center text-sm hover:text-accent transition-colors duration-200"
              >
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                ...
                className="inline-flex items-center bg-accent hover:bg-accent-dark text-accent-foreground font-semibold px-4 py-2 rounded-lg transition-colors duration-300 text-sm w-full justify-center"
              >
                WhatsApp
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/40 text-xs mt-1">
                CNPJ: XX.XXX.XXX/XXXX-XX | CRC: XXXXX/O-X
              </p>
            </div>
